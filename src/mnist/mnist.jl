...
function create_mnist_trajectory_state_and_loss(trajectory_length, σ, n_samples; rng=Random.GLOBAL_RNG, kwargs...)
...
function solve_mnist_trajectory(;τ=4, s=50.0, σ=0.001, epochs=10000, n_samples=2048, device=cpu, outputs=2, show_progress=true, fraction_to_include=1.0)
